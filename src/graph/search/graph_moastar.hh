...
class MOAStarVisitorWrapper
{
public:
    MOAStarVisitorWrapper(python::object& gi, python::object vis)
        : _gi(gi), _vis(vis) {}
...
{
public:
    MOAStarCmp(python::object cmp): _cmp(cmp) {}
...
{
public:
    MOAStarCmb(python::object cmb): _cmb(cmb) {}
...
{
public:
    MOAStarH(python::object gi, python::object h): _gi(gi), _h(h) {}
