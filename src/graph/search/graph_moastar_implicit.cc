...
struct do_moastar_search
{
    ...
    void operator()(const Graph& g, size_t s, DistanceMap dist,
                    ...
                    MOAStarVisitorWrapper vis, pair<MOAStarCmp, MOAStarCmb> cmp,
                    ...
                    pair<python::object, python::object> h) const
    {
        ...
        astar_search_no_init(g, vertex(s, g),
                             MOAStarH<dtype_t>(h.first, h.second), vis,
...
void moa_star_search_implicit(GraphInterface& g, python::object gi, size_t source,
                            ...
                            python::object inf, python::object h)
{
    run_action<graph_tool::detail::all_graph_views,mpl::true_>()
        (g, std::bind(do_moastar_search(), placeholders::_1, source,
                      placeholders::_2, make_pair(pred, cost),
                      weight,
                      MOAStarVisitorWrapper(gi, vis), make_pair(MOAStarCmp(cmp),
                                                              MOAStarCmb(cmb)),
...
void export_moastar_implicit()
{
    ...
    def("moastar_search_implicit", &moa_star_search_implicit);
}
